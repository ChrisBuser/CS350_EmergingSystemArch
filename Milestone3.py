            ...
            for word in wordList:
                ...
                for char in word:
                    ...
                    for x in morse:
                        ...
                        ##if DEBUG:
                        ##    self.screen.updateScreen(x + char + " in " + word + "\n" + str(morseCounter) + " of " + str(lenMorse))

                        ## Dot or dash?  
                        match x:
                            case '.':
                                # Transition from off to dot, then back to off
                                self.doDot()                                
                                self.doDot()
                            case '-':
                                # Transition from off to dash, then back to off
                                self.doDash()                
                                self.doDash()
                        

                        # If we are still sending process a dotDashPause event
                        # Do not process dotDashPause if final morse
                    ...
                    # Do not process letterPause if final letter
                ...
                # Do not process wordPause if final word
...
## Toggle message being transmitted
